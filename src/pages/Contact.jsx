...
const Contact = () => {
  return (
    <>
      ...
      {/* contact form */}
      <section id="form" className="py-12 sm:py-16">
        <div className="container">
          {/* section title */}
          <h2 className="text-center mb-8">Bog'lanish</h2>

          {/* form */}
          <form
            title="ppmaker contact form"
            aria-label="ppmaker contact form"
            className="bg-brand-darkblue-300/[0.02] space-y-6 p-4 pt-6 rounded-lg xs:pt-5 xs:p-5 sm:pt-12 sm:p-12 sm:rounded-2xl"
          >
            {/* full name */}
            <div className="grid grid-cols-1 gap-4 sm:gap-5 md:grid-cols-2">
              {/* name */}
              <div className="space-y-2.5 sm:space-y-3.5">
                <label htmlFor="name1">Ismingiz*</label>
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-5 md:grid-cols-2">
              {/* theme */}
              <div className="space-y-2.5 sm:space-y-3.5">
                <label htmlFor="theme">Mavzu nomi*</label>
                ...
                <input
                  ...
                  name="theme"
                  className=""
                  placeholder="Foydali taklif"
                />
              </div>

              {/* email */}
              <div className="space-y-2.5 sm:space-y-3.5">
                <label htmlFor="email">E-pochta manzilingiz*</label>
            ...
            <div className="space-y-2.5 sm:space-y-3.5">
              ...
              <textarea
                ...
                id="comment"
                name="comment"
                placeholder="Misol uchun: Menda sizlar uchun bir taklif bor..."
              />
            </div>
